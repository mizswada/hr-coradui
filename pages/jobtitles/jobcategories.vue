...
<template>
  ...
  <rs-modal
    :title="modalType == 'edit' ? 'Edit Job Category' : 'Add Job Category'"
    ok-title="Save"
    :ok-callback="saveSkill"
    v-model="showModal"
    :overlay-close="false"
  >
  <FormKit type="text"  name="title" label="Title" style="font-family: Arial;"
   />
  ...
  >
    <p>
      Are you sure want to delete this job category {{
